...
colnames(un_df)
```
I made a copy of both dataframes below
```{r}
original_literacy_df <- literacy_df
...
```{r, solution = TRUE}
### Your code here
un_df$life_expectancy_at_birth_females_males_years
...
"-99" %in% un_df$life_expectancy_at_birth_females_males_years
...
any(un_df$life_expectancy_at_birth_females_males_years == 80.4/73.2)
...
un_df <- un_df %>%
  separate(life_expectancy_at_birth_females_males_years, c("life_expectancy_at_birth_females", "life_expectancy_at_birth_males"), "/")
